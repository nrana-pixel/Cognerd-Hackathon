        ...
        <div className="p-6">
          ...
          <div className="mb-5">
            <p className="text-sm text-gray-500 leading-relaxed">
              Enter a specific question or instruction for the AI agents to evaluate. 
              Use <code className="bg-gray-100 px-1.5 py-0.5 rounded text-gray-700 font-mono text-xs">{"{brand}"}</code> as a placeholder for your brand name.
            </p>
          </div>
          ...
          <div className="relative">
            <textarea
              ...
              placeholder="e.g., How does {brand} compare to competitors for enterprise pricing?"
              className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#155DFC] focus:border-transparent resize-none bg-gray-50/50 min-h-[100px] text-sm leading-relaxed"
              autoFocus
            />
          </div>
