import { Company, CompetitorRanking, AnalysisStage, PartialResultData, BrandPrompt, Persona } from './types';
...
export type BrandMonitorAction =
  ...
  | { type: 'SET_SHOW_PERSONA_SCREEN'; payload: boolean }
  ...
  | { type: 'REMOVE_PERSONA'; payload: string }
  ...
  | { type: 'SET_ANALYZING_PROMPTS'; payload: BrandPrompt[] }
...
export interface BrandMonitorState {
  ...
  showPersonaScreen: boolean;
  showPromptsList: boolean;
  showCompetitors: boolean;
  
  // Prompts & Personas
  customPrompts: string[];
  analyzingPrompts: BrandPrompt[];
  personas: Persona[];
...
export function brandMonitorReducer(
  ...
  switch (action.type) {
    ...
    case 'SET_SHOW_PERSONA_SCREEN':
      return { ...state, showPersonaScreen: action.payload };
